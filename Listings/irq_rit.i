...
void RIT_IRQHandler (void){
 ...
 if(pause == 0){
  ...
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & (1<<10)) == 0){//int0
      ...
      ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 |= (1 << 20); //ext int selection
   }
 ...
 if(currentNote == (sizeof(song) / sizeof(song[0]))){//|| (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TC > 6000) ){ (sizeof(song) / sizeof(song[0])))
  currentNote=0;
 }
